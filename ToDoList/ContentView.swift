...
//  ToDoList
//
//  Created by Rega Rizkan Azizan on 23/11/20.
//
    ...
    var body : some View{
        ...
        HStack{
            ...
            VStack(alignment: .leading){
                ...
                Text(data.msg).lineLimit(1).font(.system(size: 12))
                
            }.padding()
            Spacer()
            
            VStack(alignment: .leading, spacing : 5){
                Text(data.day).font(.system(size: 8))
                Text(data.time).font(.system(size: 8))
            }
